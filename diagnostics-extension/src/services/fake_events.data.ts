...
export const isEventSupported = async (eventType: EventCategory): Promise<EventSupportStatusInfo> => {
  let res: EventSupportStatusInfo = {};
  return res;
}
export const startCapturingEvents = async (eventType: EventCategory): Promise<void> => {
  return;
}
export const stopCapturingEvents = async (eventType: EventCategory): Promise<void> => {
  return;
}
